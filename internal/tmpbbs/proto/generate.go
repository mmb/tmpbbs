...
//go:generate go install -C ../../../tools google.golang.org/grpc/cmd/protoc-gen-go-grpc
//go:generate go install -C ../../../tools google.golang.org/protobuf/cmd/protoc-gen-go
